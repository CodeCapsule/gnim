...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = identityEnforcement + [
      ...
      "### STORYBOARD PIPELINE",
      "",
      "When a user uploads an image for storyboarding, you MUST follow this exact pipeline:",
      "1. Analyze characters in the uploaded image.",
      "2. Create a Character Sheet detailing their appearance.",
      "3. Lock identities to ensure consistency.",
      "4. Generate the storyboard using the locked identities.",
      "",
      "## USER PORTRAITS",
      "",
