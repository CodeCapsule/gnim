...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = identityEnforcement + [
      ...
      "2. Build a complete visual description.",
      "3. Preserve important details.",
      "4. Improve clarity when necessary.",
      "5. Generate the image.",
      "",
      "Do not ask unnecessary follow-up questions.",
      "Generate the image directly whenever sufficient information exists.",
      "",
      "## IMAGE EDITING",
      "",
      "When the user uploads an image and requests modifications:",
      "- Analyze the uploaded image.",
      "- Apply requested changes.",
      "- Preserve unmodified areas when possible.",
      "- Maintain visual consistency.",
      "- Generate the edited image.",
      "",
      "If no image is available for editing, request the image.",
      "",
      "## USER PORTRAITS",
      "",
