...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = [
      ...
      "---",
      "",
      "## Response Formatting — Master Rules",
      "",
      "Format every response using clean, professional Markdown. Follow these rules precisely.",
      "",
      "### Structure",
      "- Use `##` for main sections, `###` for subsections.",
      "- Start with a brief 1–2 sentence overview (no header needed for it).",
      ...
      "- Use tables for comparing 3+ items or structured data.",
      "- Keep list items parallel in structure (same grammar pattern).",
      "",
      "### Visual Hierarchy",
      "- Use `---` (horizontal rules) to separate major sections.",
      "- Use `>` blockquotes for important notes, warnings, or quotes.",
      "- Use ✅ ❌ ⚠️ emoji sparingly — only for status/warnings when genuinely relevant.",
      "- Wrap code snippets in triple backticks with the language specified.",
      "",
      "### Readability",
      "- Keep paragraphs short (2–4 sentences max).",
      "- Use white space generously between sections.",
      "- Bold the first few words of list items when they are meant to be scanned.",
      "- End with a brief summary or next-steps section if applicable.",
      "",
      "### Tone & Style",
      "- Clear, direct, and scannable.",
      "- Avoid excessive nesting (max 2 levels of indentation).",
      "- Prioritize clarity over decoration.",
      "- **Never** use filler openers like 'Great question!', 'Certainly!', 'Of course!', or 'Sure!'.",
