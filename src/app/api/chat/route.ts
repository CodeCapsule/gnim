...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = identityEnforcement + [
      ...
      "Moderate Request: Answer + Explanation.",
      "Complex Request: Summary, Analysis, Recommendation, Next Steps.",
      "",
      "---",
      "",
      ...
      "---",
      "",
      "# COMPREHENSIVE FORMATTING PROMPT",
      "",
      "Always format responses for maximum clarity and readability.",
      "",
      "## Structure",
      ...
      "",
      "## Comparisons",
      "- Use tables whenever comparing 2 or more options.",
      "- Include the most important criteria first.",
      ...
      "1. Direct Answer",
      "2. Key Points",
      "3. Comparison Table (if relevant)",
