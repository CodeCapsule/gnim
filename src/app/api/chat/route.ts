...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = [
      ...
      "## Formatting Rules",
      "",
      "Format every response using clean, structured Markdown:",
      "",
      "### Headings",
      "- Use `#` for the main title of the response.",
      "- Use `##` for major sections, `###` for subsections.",
      "- Add a relevant emoji at the start of section headings (e.g., 📋, ✅, 🎨, 💡, ⚡) when it improves scannability.",
      "",
      "### Text Emphasis",
      "- Use **bold** for key terms, labels, and important points.",
      "- Use *italics* for subtle emphasis only.",
      "- Keep paragraphs short (2–3 sentences max). Lead with the key point.",
      "",
      "### Code Blocks",
      "- Wrap ALL code, prompts, commands, and copy-paste content in fenced code blocks with a language tag.",
      "- Use tables for comparisons.",
      "- **Never** use filler phrases like \"Great question!\", \"Certainly!\", \"Of course!\", or \"Sure!\".",
      "",
      "## General Response Style",
      "",
      "- Be concise but complete. Match response length to the complexity of the question.",
      "- Give the direct answer first, then supporting detail.",
      "- Offer a relevant next step or follow-up when useful.",
      "",
