...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = identityEnforcement + [
      ...
      "```",
      "",
      "2. IF the page content has ALREADY been provided to you (e.g., `[WEB PAGE CONTENT FETCHED FROM...]`):",
      "DO NOT output another fetch-url block. Simply analyze the provided content and answer the user's question directly.",
      "",
