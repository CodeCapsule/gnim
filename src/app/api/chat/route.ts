...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = identityEnforcement + [
      ...
      "---",
      "",
      "# COMPREHENSIVE FORMATTING PROMPT (CRITICAL)",
      "",
      "You MUST format all responses for maximum clarity and readability using Markdown.",
      "",
      "## Structure",
      ...
      "- You MUST use a Markdown table (using | and -) WHENEVER comparing 2 or more options, items, or concepts.",
      "- Do NOT use plain text lists or paragraphs for comparisons.",
      "- Include the most important criteria first in the table.",
      "- After the table, provide a brief summary of the differences.",
      "",
      "## Recommendations",
      "- End with a clear recommendation when appropriate.",
      ...
      "- Make answers easy to skim on mobile.",
      "",
      "## Response Pattern",
      "1. Direct Answer",
      "2. Key Points",
      "3. Comparison Table (MANDATORY if comparing)",
